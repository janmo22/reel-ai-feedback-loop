          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button 
                ...
                className="w-full sm:w-auto bg-flow-electric hover:bg-flow-electric/90 font-medium py-6 px-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 text-white disabled:bg-gray-300 disabled:text-gray-500"
              >
                {isUploading ? (
                  <>
  ...
  return (
    <button 
      ...
      className={`flex flex-col items-start text-left p-3 rounded-md border transition-all duration-200 ${
        isSelected 
          ? "border-flow-electric bg-flow-electric/10 shadow-md" 
          : "border-border/60 hover:border-flow-electric/60 hover:bg-flow-electric/5"
      }`}
    >
