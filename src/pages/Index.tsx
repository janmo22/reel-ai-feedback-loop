          ...
          <div className="container mx-auto py-8 px-4 max-w-6xl">
            <div className="mb-8">
              <h1 className="text-3xl font-bold">
                <LayoutDashboard className="inline mr-2 text-flow-electric" size={28} />
                Dashboard 
              </h1>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                <CardHeader className="pb-4">
                  <CardTitle className="flex items-center gap-2">
                    <Upload className="h-5 w-5 text-flow-electric" />
                    Analizar un nuevo reel
                  </CardTitle>
                  <CardDescription>
                    Sube tu video para recibir un análisis detallado de IA
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4 text-sm">
                    Obtén feedback profesional con recomendaciones para mejorar tu contenido.
                  </p>
                  <Button asChild className="w-full bg-flow-blue hover:bg-flow-blue/90">
              ...
              <Card>
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    Revisa tus reels anteriores y sus análisis
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4 text-sm">
                    Accede a todos tus análisis anteriores y compara tu progreso.
                  </p>
            ...
            <div className="mt-8">
              <Card className="bg-gradient-to-br from-flow-blue/5 to-flow-accent/10">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    <div className="p-3 rounded-full bg-flow-blue/20">
                      <BrainCircuit className="h-8 w-8 text-flow-blue" />
                    </div>
                    <div>
                      <h3 className="text-xl font-semibold mb-1">Optimiza tus reels con IA</h3>
                      <p className="text-sm text-muted-foreground">
                        Flow ReelAI analiza tus videos para ayudarte a maximizar su alcance y engagement.
                      </p>
                    </div>
                  </div>
                </CardContent>
