          ...
          <Tabs defaultValue="login" className="w-full">
            <CardHeader className="pb-2 text-center">
              <div className="flex flex-col items-center justify-center mb-6">
                ...
                <p className="text-muted-foreground text-sm">Analiza tus reels con IA</p>
              </div>
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="login" className="data-[state=active]:bg-flow-blue data-[state=active]:text-white font-medium">
                  Iniciar sesión
                </TabsTrigger>
                <TabsTrigger value="register" className="data-[state=active]:bg-flow-blue data-[state=active]:text-white font-medium">
                  Registrarse
                </TabsTrigger>
              </TabsList>
            </CardHeader>
                ...
                <form onSubmit={handleLogin}>
                  <div className="space-y-4">
                    ...
                    <Button 
                      type="button" 
                      variant="outline" 
                      className="w-full flex gap-2 items-center justify-center border h-11 font-medium" 
                  ...
                  <form onSubmit={handleRegister}>
                    <div className="space-y-4">
                      ...
                      <Button 
                        type="button" 
                        variant="outline" 
                        className="w-full flex gap-2 items-center justify-center h-11 font-medium" 
                        onClick={handleGoogleLogin} 
                        disabled={googleLoading}
                      >
                        {googleLoading ? (
