  ...
  try {
    ...
    try {
      ...
      feedbackData = {
        ...
        seoAndDiscoverability_recommendations: "Optimiza palabras clave y hashtags",
        engagementOptimization_recommendations: "Mejora la interacción y tiempo de visualización"
      }
    }
